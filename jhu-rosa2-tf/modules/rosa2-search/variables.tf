...
variable "latin_stemmer_rules_file" {
  description = "Local path to the Latin stemmer override rules (rosa-search/opensearch/latin-stemmer-rules.txt)."
  type        = string
}

variable "latin_charmap_file" {
  description = "Local path to the Latin character normalization mappings (rosa-search/opensearch/latin-charmap.txt)."
  type        = string
}
...
variable "search_lambda_source_dir" {
  description = "Local path to the search proxy source directory (rosa-search/lambda/search_proxy). Zipped as-is."
  type        = string
}

variable "admin_lambda_source_dir" {
  description = "Local path to the admin Lambda source directory (rosa-search/lambda/admin). Zipped as-is."
  type        = string
}
