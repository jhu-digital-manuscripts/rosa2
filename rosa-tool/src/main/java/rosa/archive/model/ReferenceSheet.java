...
public class ReferenceSheet implements HasId {
    ...
    /**
     * Finds the key (primary name) for an entry that has the specified value in the given column.
     * This is useful for resolving ISNI identifiers back to standard names, where the ISNI
     * appears in a specific column (e.g., column 6 in people.csv).
     *
     * @param value       the value to search for (e.g., an ISNI like "0000 0001 2278 5193")
     * @param columnIndex the column index to search in (0-based)
     * @return the key (primary name) if found, or {@code null} if no match
     */
    public String findKeyByColumnValue(String value, int columnIndex) {
