...
- [Usage](../docs/usage.md) — CLI commands, options, and examples
...
- [Search](../docs/search.md) — JHSearch service design, Opensearch indexes, and query examples
- [AoR Data Model](../docs/aor-data-model.md) — Annotation types and data structures
- [Deployment](../docs/deployment.md) — Building, releasing, and deploying the tool
