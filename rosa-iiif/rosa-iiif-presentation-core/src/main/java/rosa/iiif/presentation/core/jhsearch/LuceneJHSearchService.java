...
public class LuceneJHSearchService extends LuceneSearchService implements JHSearchService {
    ...
    static {
        ...
        searchcategories.put("hamletcollection",
                new JHSearchCategory[] {
                        JHSearchCategory.COMMON_NAME, JHSearchCategory.NUM_PAGES, JHSearchCategory.REPOSITORY,
                        JHSearchCategory.DATE});
        ...
        searchfields.put("aor2collection", searchfields.get("aorcollection"));
        searchcategories.put("aor2collection", searchcategories.get("aorcollection"));
        ...
        searchfields.put("ptolemycollection",
                new JHSearchField[] {
                        JHSearchField.DESCRIPTION,
                        JHSearchField.TITLE,
                        JHSearchField.PEOPLE,
        ...
        searchcategories.put("ptolemycollection",
                new JHSearchCategory[] {
                        JHSearchCategory.AUTHOR, JHSearchCategory.COMMON_NAME
                });
    }
