...
public class PleaidasGazetteer extends SimpleExternalResourceDb {
    private static String pleiades_res_path = "/pleiades-places-latest.json.gz";
    private static Logger logger = Logger.getLogger(PleaidasGazetteer.class.getName());

    public PleaidasGazetteer(InputStream is) throws IOException {
    ...
    public PleaidasGazetteer() throws IOException {
        this(PleaidasGazetteer.class.getResourceAsStream(pleiades_res_path));
    }
