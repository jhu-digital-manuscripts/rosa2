...
public class ImageListDecorator {
    ...
    private void doBook(BookCollection col, String book) {
        ...
        images.forEach(image -> image.setAutoGeneratedName(true));
    ...
    // Assume calls to this method are always because the pageLabel is declared (not auto-generated)
