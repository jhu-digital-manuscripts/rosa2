...
public class RosaSpanishAnalyzer extends StopwordAnalyzerBase {
     ...
     */
    public RosaSpanishAnalyzer(CharArraySet stopwords) {
     ...
     */
    public RosaSpanishAnalyzer(CharArraySet stopwords, CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected TokenStream buildResultTokenStream(TokenStream result) {
        ...
        return new SpanishLightStemFilter(result);
    }
}
