...
public class RosaItalianAnalyzer extends StopwordAnalyzerBase {
     ...
     */
    public RosaItalianAnalyzer(CharArraySet stopwords) {
     ...
     */
    public RosaItalianAnalyzer(CharArraySet stopwords, CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected TokenStream buildResultTokenStream(TokenStream result) {
        ...
        return new ItalianLightStemFilter(result);
    }
}
