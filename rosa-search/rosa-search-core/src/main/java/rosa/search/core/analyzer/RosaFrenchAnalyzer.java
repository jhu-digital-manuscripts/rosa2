 ...
 */
public class RosaFrenchAnalyzer extends StopwordAnalyzerBase {
     ...
     *          a stopword set
     */
    public RosaFrenchAnalyzer(CharArraySet stopwords){
     ...
     */
    public RosaFrenchAnalyzer(CharArraySet stopwords, CharArraySet stemExclutionSet) {
        super(stopwords);
    ...
    protected TokenStream buildResultTokenStream(TokenStream result) {
        ...
        return new FrenchLightStemFilter(result);
    }
}
