...
export function InitializationError({ error, onRetry }) {
  return (
    <ErrorDisplay error={error} title="Failed to Initialize Search" onRetry={onRetry} fullScreen />
  );
}
...
export function SearchError({ error, onRetry }) {
  return <ErrorDisplay error={error} title="Search Failed" onRetry={onRetry} />;
}
